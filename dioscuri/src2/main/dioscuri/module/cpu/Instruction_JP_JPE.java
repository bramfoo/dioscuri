...
/**
 * Intel opcode 7A<BR>
 * Conditional short jump on parity / parity even.<BR>
 * Displacement is relative to next instruction.<BR>
 * Flags modified: none
 */
public class Instruction_JP_JPE implements Instruction
{
    ...
    public void execute()
    {
        ...
        // Jump if parity flag set, otherwise skip instruction
