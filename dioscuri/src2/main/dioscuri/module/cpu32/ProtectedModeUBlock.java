...
//                     validateOperand(freg0);
        ...
        case FCOS: {
            ...
            freg0 = Math.cos(freg0);
                ...
                case FSCALE: freg0 = dioscuri.module.cpu.Util.scalb(freg0, (int) freg1); break;
//                 case FSINCOS: {
//                     freg1 = sin(freg0);
//                     freg0 = cos(freg0);
//                 } break;
...
//                 } break;
    ...
    private final void outsb_a16(int port, Segment storeSegment) throws ModuleException 
    {
    if (!checkIOPermissionsByte(port)) {
    ...
    private final void outsw_a16(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsShort(port)) {
    ...
    private final void outsd_a16(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsInt(port)) {
    ...
    private final void rep_outsb_a16(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsByte(port)) {
    ...
    private final void rep_outsw_a16(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsShort(port)) {
    ...
    private final void rep_outsd_a16(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsInt(port)) {
        System.err.println("OUTSD_A16: Denied IO Port Access [port:0x" + Integer.toHexString(port) + " cpl:" + cpu.getCPL() + "]");
        throw (ProcessorException) exceptionGP;
    ...
    private final void outsb_a32(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsByte(port)) {
    ...
    private final void outsw_a32(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsShort(port)) {
    ...
    private final void outsd_a32(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsInt(port)) {
        System.err.println("OUTSB_A32: Denied IO Port Access [port:0x" + Integer.toHexString(port) + " cpl:" + cpu.getCPL() + "]");
        throw (ProcessorException) exceptionGP;
    ...
    private final void rep_outsb_a32(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsByte(port)) {
    ...
    private final void rep_outsw_a32(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsShort(port)) {
    ...
    private final void rep_outsd_a32(int port, Segment storeSegment) throws ModuleException
    {
    if (!checkIOPermissionsInt(port)) {
