...
public class Instruction_INC_BPTest extends AbstractInstructionTest {
    ...
    */
    ...
    public void testExecute() {
        ...
        assertEquals(BP_ERROR, (byte) 0x0F, cpu.getRegisterValue("BP")[1]);
        ...
        assertEquals(BP_ERROR, (byte) 0x7F, cpu.getRegisterValue("BP")[0]);
        assertEquals(BP_ERROR, (byte) 0xFF, cpu.getRegisterValue("BP")[1]);
        ...
        assertEquals(BP_ERROR, (byte) 0xFF, cpu.getRegisterValue("BP")[0]);
        assertEquals(BP_ERROR, (byte) 0xFF, cpu.getRegisterValue("BP")[1]);
