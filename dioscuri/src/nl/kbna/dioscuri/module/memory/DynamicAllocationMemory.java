...
package nl.kbna.dioscuri.module.memory;
 ...
 * memory.size                 : 1 MB
 * 
 * Notes: This memory implementation using dynamic allocation was designed and coded by 
...
public class DynamicAllocationMemory extends ModuleMemory
{
	...
	private int blockIndex;		// Index into ram; shifting by this index determines corresponding ramBlock for memory address

    static protected long A20mask;   // Mask used to set/clear 20th bit in memory addresses
    
    // Logging
    private static Logger logger = Logger.getLogger("nl.kbna.dioscuri.module.memory");
    ...
    public DynamicAllocationMemory(Emulator owner)
    {
        ...
        // Split ram into sections, more or less arbitrarily chosen size (multiple of two)
        ramBlock = 64;
    ...
    public boolean reset()
    {
        ...
        logger.log(Level.SEVERE, "[" + MODULE_TYPE + "] Module has been reset.");
        return true;
    }
    ...
    public String getDump()
    {
        ...
        for (int row = 0; row < 200; row++)
        {
            ...
            for (int col = 0; col < 16; col++)
            {
                ...
                dump += Integer.toHexString( 0x100 | value & 0xFF).substring(1).toUpperCase() + space;
            }
            dump += ret;
        }
    ...
    public byte getByte(int address)
    {
        ...
        //logger.log(Level.SEVERE, "[" + MODULE_TYPE + "]" + " getByte(" + address + ")");
        ...
        try
        {
            ...
            if (watchValue == true && address == watchAddress)
            {
                ...
                logger.log(Level.CONFIG, "[" + MODULE_TYPE + "] " + cpu.getRegisterHex(0) + ":"
                            + cpu.getRegisterHex(1) + " Watched BYTE at address " + watchAddress
                            + " is read: [" + Integer.toHexString(addrValue).toUpperCase() + "]");
            }
    ...
    {
        //logger.log(Level.SEVERE, "[" + MODULE_TYPE + "]" + " setByte(" + address + ", " + value + ")");
        ...
        try  
        {
            ...
            else
            {
                ...
                if (ram[addressBlock] == null) {
                    logger.log(Level.SEVERE, "Allocating an extra " + ramBlockSize + " bytes for block " + addressBlock);
        ...
        {
            logger.log(Level.SEVERE, "[" + MODULE_TYPE + "] setByte: setByte: Out of memory during write byte");
        }
    }
    ...
    public byte[] getWord(int address)
    {
        ...
        //logger.log(Level.SEVERE, "[" + MODULE_TYPE + "]" + " getWord(" + address + ")");
        ...
        try  
        {
            ...
            {
                logger.log(Level.CONFIG, "[" + MODULE_TYPE + "] " + cpu.getRegisterHex(0) + ":" + cpu.getRegisterHex(1) + " Watched WORD at address " + watchAddress + " is read: [" + Integer.toHexString(addrValue2).toUpperCase() + "] [" + Integer.toHexString(addrValue1).toUpperCase() + "]");
            }
    ...
    public void setWord(int address, byte[] value)
    {
        ...
        //logger.log(Level.SEVERE, "[" + MODULE_TYPE + "]" + " setWord(" + address + ")");
        ...
        try  
        {
            ...
            else
            {
                ...
                if (ram[addressBlock1] == null) {
                    logger.log(Level.SEVERE, "Allocating an extra " + ramBlockSize + " bytes for block " + addressBlock1);
                ...
                if (ram[addressBlock2] == null) {
                    logger.log(Level.SEVERE, "Allocating an extra " + ramBlockSize + " bytes for block " + addressBlock2);
        ...
        {
            logger.log(Level.SEVERE, "[" + MODULE_TYPE + "] setWord: Out of memory during write word");
        }
    }
    ...
    {
        // logger.log(Level.SEVERE, "[" + MODULE_TYPE + "]" + " setBytes(" + address + ")");
        ...
        {
            logger.log(Level.SEVERE, "[" + MODULE_TYPE + "] setBytes: Out of memory during write stream of bytes");
    ...
    public void setRamSizeInMB(int ramSizeMB)
    {
        ...
        logger.log(Level.SEVERE, "[" + MODULE_TYPE + "]" + " setting ram size to: " + ramSizeMB + "Mb, ramSize = " + ramSize + ", blocks = " + ramBlock + ", block size = " + ramBlockSize);
    }
