...
public class ATAConstants
{
    ...
    //Define Ports
    // I/O ports 01F0-01F7 - Primary ATA controller - HDC 1 (1st Fixed Disk Controller) (ISA, EISA)
    ...
    public static final boolean SUPPORT_REPEAT_SPEEDUPS = true;  //TODO: what is this?
    public static final boolean IS_LOW_LEVEL_CDROM = false;
    
    public static final boolean WITH_WIN32 = true;
    
    public static final String IDE_MODEL = "Generic 1234                            "; //40 char's long
    ...
    public static final boolean IS_CONNER_CFA540A_DEFINED = false;  //not apparently defined in BOCHS
