    ...
    public void execute() throws CPUInstructionException
    {
        ...
        case 2: // NOT: reverse each bit of r/m16 or r/m32
            ...
            if (((addressByte >> 6) & 0x03) == 3)
            {
                ...
                if (cpu.doubleWord)
                {
                    // Determine extra source value from addressbyte, ANDing it with 0000 0111
            ...
            else
            {
                ...
                if (cpu.doubleWord)
                {
                    ...
                    if (memoryReferenceLocation[CPU.REGISTER_GENERAL_LOW] == 0x00 || memoryReferenceLocation[CPU.REGISTER_GENERAL_LOW] == 0x01)
                    {
                            // Overflow
        ...
        case 3: // NEG
            ...
            destinationRegister = Util.subtractWords(new byte[]{0, 0}, sourceValue, 0);
            
            // Copy result back in source
            System.arraycopy(destinationRegister, 0, sourceValue, 0, destinationRegister.length);
            ...
            cpu.flags[CPU.REGISTER_FLAGS_CF] = sourceValue[CPU.REGISTER_GENERAL_LOW] == 0 && sourceValue[CPU.REGISTER_GENERAL_HIGH] == 0? false: true;  

            // Set OF flag
            cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(new byte[]{0, 0}, tempResult, sourceValue, 0); 
            // Set AF flag
            cpu.flags[CPU.REGISTER_FLAGS_AF] = (sourceValue[CPU.REGISTER_GENERAL_LOW] & 0x0F) != 0 ? true : false;
            // Test ZF on result
        ...
        case 4: // MUL eAX. 
            ...
            if (cpu.doubleWord)
            {
                ...
                // Add (eAX * REGX)<<16
                result += ((( ((((int) eDestinationRegister[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((int) eDestinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) 
                * ( ((((int)sourceValue[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((int) sourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) )<<16);
                // Add (AX * eREGX)<<16
                result += ((( ((((int) destinationRegister[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((int) destinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) 
                        * ( ((((int)eSourceValue[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((int) eSourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) )<<16);
                // Add (eAX * eREGX)<<32
                result += ((( ((((int) eDestinationRegister[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((int) eDestinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) 
                        * ( ((((int)eSourceValue[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((int) eSourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) )<<32);
            }
            ...
            // Set OF, CF if significant bits are carried into upper half of result, else clear them. 
            if (cpu.doubleWord)
            {
                cpu.flags[CPU.REGISTER_FLAGS_OF] = cpu.flags[CPU.REGISTER_FLAGS_CF] = eDestinationRegister2[CPU.REGISTER_GENERAL_HIGH] == 0 && eDestinationRegister2[CPU.REGISTER_GENERAL_LOW] == 0? false : true;
                ...
                cpu.flags[CPU.REGISTER_FLAGS_ZF] = eDestinationRegister[CPU.REGISTER_GENERAL_HIGH] == 0x00 && eDestinationRegister[CPU.REGISTER_GENERAL_LOW] == 0x00 &&
                                                   destinationRegister[CPU.REGISTER_GENERAL_HIGH] == 0x00 && destinationRegister[CPU.REGISTER_GENERAL_LOW] == 0x00 ? true : false;
                cpu.flags[CPU.REGISTER_FLAGS_SF] = eDestinationRegister2[CPU.REGISTER_GENERAL_HIGH] < 0 ? true : false;
            }
            else
            {
                cpu.flags[CPU.REGISTER_FLAGS_OF] = cpu.flags[CPU.REGISTER_FLAGS_CF] = destinationRegister2[CPU.REGISTER_GENERAL_HIGH] == 0 && destinationRegister2[CPU.REGISTER_GENERAL_LOW] == 0? false : true;

                // Mimic Bochs' flag behaviour
                cpu.flags[CPU.REGISTER_FLAGS_PF] = Util.checkParityOfByte(destinationRegister[CPU.REGISTER_GENERAL_LOW]);
                cpu.flags[CPU.REGISTER_FLAGS_AF] = false;
                cpu.flags[CPU.REGISTER_FLAGS_ZF] = destinationRegister[CPU.REGISTER_GENERAL_HIGH] == 0x00 && destinationRegister[CPU.REGISTER_GENERAL_LOW] == 0x00 ? true : false;
        ...
        case 5: // IMUL 16-bit: AX*r/mword -> DX:AX or 32-bit: eAX*r/mword -> eDX:eAX.
            // Flags: OF, CF set to 0 if upper half of result is 0; SF, ZF, AF, PF are undefined.
            ...
            if (cpu.doubleWord)
            {
                ...
                // Current result contains AX * REGX
                // Add (eAX * REGX)<<16
                result += ((( (((int) eDestinationRegister[CPU.REGISTER_GENERAL_HIGH])<<8) + (((int) eDestinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) 
                * ( (((int)sourceValue[CPU.REGISTER_GENERAL_HIGH])<<8) + (((int) sourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) )<<16);
                // Add (AX * eREGX)<<16
                result += ((( (((int) destinationRegister[CPU.REGISTER_GENERAL_HIGH])<<8) + (((int) destinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) 
                        * ( (((int)eSourceValue[CPU.REGISTER_GENERAL_HIGH])<<8) + (((int) eSourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) )<<16);
                // Add (eAX * eREGX)<<32
                result += ((( (((int) eDestinationRegister[CPU.REGISTER_GENERAL_HIGH])<<8) + (((int) eDestinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) 
                        * ( (((int)eSourceValue[CPU.REGISTER_GENERAL_HIGH])<<8) + (((int) eSourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF)) )<<32);
            }
            ...
            break;  // IMUL 16-bit: AX*r/mword -> DX:AX or 32-bit: eAX*r/mword -> eDX:eAX.
        ...
        case 6: // DIV eAX;
            ...
            if (!cpu.doubleWord)    // 16 bit registers
            {
                ...
                long dividend = ((((long)destinationRegister2[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<24) + ((((long)destinationRegister2[CPU.REGISTER_GENERAL_LOW]) & 0xFF)<<16) + ((((long)destinationRegister[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((long) destinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF);
                long divisor = ((((long)sourceValue[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((long) sourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF);
            ...
            else    // 32 bit registers
            {
                ...
                logger.log(Level.WARNING, "[" + cpu.getType() + "] Unary Group 3 (0xF7|6) not (properly) implemented");
                
                long dividend =  ((((long)eDestinationRegister2[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<56) + ((((long) eDestinationRegister2[CPU.REGISTER_GENERAL_LOW]) & 0xFF)<<48) + ((((long)destinationRegister2[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<40) + ((((long)destinationRegister2[CPU.REGISTER_GENERAL_LOW]) & 0xFF)<<32) + ((((int)eDestinationRegister[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<24) + ((((int) eDestinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF)<<16) + ((((int)destinationRegister[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((int) destinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF);
                long divisor =   ((((long)eSourceValue[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<24) + ((((long)eSourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF)<<16) + ((((long)sourceValue[CPU.REGISTER_GENERAL_HIGH]) & 0xFF)<<8) + (((long) sourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF);
                // Calculate quotient
                long quotient = dividend / divisor; 
                // Calculate remainder
                long remainder = dividend % divisor;
        ...
        case 7: // IDIV
            // FIXME: Unsure about the value of DX/eDX. Intel specs state that DX/eDX should contain sign extension of AX/eAX. 
            // But is that already before execution of IDIV? This implementation takes that as an assumption. 
            ...
            {
                long dividend = ((((int)destinationRegister2[CPU.REGISTER_GENERAL_HIGH]) & 0xFF) << 24) + ((((int)destinationRegister2[CPU.REGISTER_GENERAL_LOW]) & 0xFF) << 16) + ((((int)destinationRegister[CPU.REGISTER_GENERAL_HIGH]) & 0xFF) << 8) + (((int) destinationRegister[CPU.REGISTER_GENERAL_LOW]) & 0xFF);
                long divisor =  ((((int)sourceValue[CPU.REGISTER_GENERAL_HIGH]) & 0xFF) << 8) + (((int) sourceValue[CPU.REGISTER_GENERAL_LOW]) & 0xFF);
                
                // Calculate quotient (DX contains sign extension of AX), remainder
                long quotient = dividend / divisor;
                long remainder = dividend % divisor; 
