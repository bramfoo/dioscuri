...
//      return (reg2 > reg0);
    ...
    public static int reg0_hef_IN_O8_cpl_iopl_tss_reg0_ioports(int cpl, int iopl, Segment tss, int reg0, IOPortHandler ioports) throws ModuleException
    {
    ...
    public static int reg0_hef_IN_O16_cpl_iopl_tss_reg0_ioports(int cpl, int iopl, Segment tss, int reg0, IOPortHandler ioports) throws ModuleException
    {
    ...
    public static int reg0_hef_IN_O32_cpl_iopl_tss_reg0_ioports(int cpl, int iopl, Segment tss, int reg0, IOPortHandler ioports) throws ModuleException
    {
    ...
    public static void ioportwrite_hef_OUT_O8_cpl_iopl_tss_reg0_reg1_ioports(int cpl, int iopl, Segment tss, int reg0, int reg1, IOPortHandler ioports) throws ModuleException
    {
    if (checkIOPermissionsByte(cpl, iopl, tss, reg0))
    ...
    public static void ioportwrite_hef_OUT_O16_cpl_iopl_tss_reg0_reg1_ioports(int cpl, int iopl, Segment tss, int reg0, int reg1, IOPortHandler ioports) throws ModuleException
    {
    if (checkIOPermissionsShort(cpl, iopl, tss, reg0))
    ...
    public static void ioportwrite_hef_OUT_O32_cpl_iopl_tss_reg0_reg1_ioports(int cpl, int iopl, Segment tss, int reg0, int reg1, IOPortHandler ioports) throws ModuleException
    {
    if (checkIOPermissionsInt(cpl, iopl, tss, reg0))
