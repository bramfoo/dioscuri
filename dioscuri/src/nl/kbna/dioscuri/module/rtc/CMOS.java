/*
 * $Revision: 1.4 $ $Date: 2007-08-27 07:24:37 $ $Author: blohman $
 * 
...
public class CMOS
{
    ...
    private final static int CMOS_SIZE          = 128;  // Upper limit of memory size (only bits 0-6 can be used) 
    ...
    //     06h-0Fh unused
    protected final static int FLOPPYDRIVE_TYPE   = 0x10; // read/write   : defines the type of floppy drives
    
    protected final static int IBM_PS2_HD1_DATA   = 0x11; // read/write   : defines the type of first PS/2 hard disk drive
    ...
    protected final static int IBM_HD_DATA        = 0x12; // read/write   : defines the type of hard disk drives

    protected final static int IBM_PS2_HD2_DATA   = 0x13; // read/write   : defines the type of second PS/2 hard disk drive
    ...
    protected final static int IBM_EQUIPMENT      = 0x14; // read/write   : unused, defines number of floppy drives, monitor type, etc.
    ...
    protected final static int IBM_EXTEND_MEM_HIGH= 0x18; // read/write   : unused
    ...
    protected final static int AWARD_HD1_USERDEF  = 0x2D; // read/write   : defines the boot order (floppy,hd)
    ...
    protected final static int IBM_RTC_CENTURY    = 0x32; // read/write   : defines the century in BCD
    ...
    protected final static int IBM_PS2_RTC_CENTURY= 0x37; // read/write   : copy of 0x32, used for Windows XP
    protected final static int ELTORITO_BOOT      = 0x38; // read/write   : eltorito boot sequence + boot signature check
    protected final static int ATA_POLICY_0_1     = 0x39; // read/write   : ata translation policy - ata0 + ata1
    protected final static int ATA_POLICY_2_3     = 0x3A; // read/write   : ata translation policy - ata2 + ata3
    protected final static int ELTORITO_BOOT2     = 0x3D; // read/write   : eltorito boot sequence 2 + boot signature check
    ...
    {
        // Check if custom time should be used; system time has already been set as default.
        if (!systemTime)
        {
     ...
     * Example of conversion: int 22 will result in 0x22 (or 0010.0010).
     * 
     * @param decimalValue
     ...
     * Example of conversion: 0x22 (or 0010.0010) will result in int 22.
     * 
     * @param bcdValue
