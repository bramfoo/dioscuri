...
public class UCodeStaticMethods {
    ...
    public static int reg0_nef_LOAD0_FLAGS_cflag_pflag_aflag_zflag_sflag_tflag_iflag_dflag_oflag_iopl_ntflag(
            ...
            int iflag, int dflag, int oflag, int iopl, int ntflag) {
        int eflags = 0;
        eflags |= ntflag << 14;
        eflags |= iopl << 12;
        eflags |= oflag << 11;
    ...
    public static int reg0_nef_LOAD0_EFLAGS_cflag_pflag_aflag_zflag_sflag_tflag_iflag_dflag_oflag_iopl_ntflag_rflag_vmflag_acflag_viflag_vipflag_idflag(
            int cflag, int pflag, int aflag, int zflag, int sflag, int tflag,
            int iflag, int dflag, int oflag, int iopl, int ntflag, int rflag,
            int vmflag, int acflag, int viflag, int vipflag, int idflag) {
        int eflags = 0;
        eflags |= idflag << 21;
        eflags |= vipflag << 20;
        eflags |= viflag << 19;
    ...
    // public static Segment es_hef_STORE0_ES_ldtr_gdtr_reg0(Segment ldtr,
    // Segment gdtr, int reg0)
    // {
    // reg0 &= 0xffff;
    // if (reg0 < 0x4)
    ...
    // public static Segment cs_hef_STORE0_CS_reg0_cs(Segment ldtr, Segment
    // gdtr, int reg0)
    // {
    ...
    // public static Segment ss_hef_STORE0_SS_ldtr_gdtr_reg0(Segment ldtr,
    // Segment gdtr, int reg0)
    // {
    // reg0 &= 0xffff;
    // if (reg0 < 0x4)
    ...
    // public static Segment ds_hef_STORE0_DS_ldtr_gdtr_reg0(Segment ldtr,
    // Segment gdtr, int reg0)
    // {
    // reg0 &= 0xffff;
    // if (reg0 < 0x4)
    ...
    // public static Segment fs_hef_STORE0_FS_ldtr_gdtr_reg0(Segment ldtr,
    // Segment gdtr, int reg0)
    // {
    // reg0 &= 0xffff;
    // if (reg0 < 0x4)
    ...
    // public static Segment gs_hef_STORE0_GS_ldtr_gdtr_reg0(Segment ldtr,
    // Segment gdtr, int reg0)
    // {
    // reg0 &= 0xffff;
    // if (reg0 < 0x4)
    ...
    public static void memorywrite_hef_STORE0_MEM_BYTE_seg0_addr0_reg0(
            Segment seg0, int addr0, int reg0) {
        seg0.setByte(addr0, (byte) reg0);
    }

    public static void memorywrite_hef_STORE0_MEM_WORD_seg0_addr0_reg0(
            Segment seg0, int addr0, int reg0) {
        seg0.setWord(addr0, (short) reg0);
    }

    public static void memorywrite_hef_STORE0_MEM_DWORD_seg0_addr0_reg0(
            Segment seg0, int addr0, int reg0) {
    ...
    // public static boolean vmflag_hef_STORE0_EFLAGS_vmflag_reg0(boolean
    // vmflag, int reg0)
    // {
    ...
    // public static boolean acflag_hef_STORE0_EFLAGS_reg0(boolean acflag, int
    // reg0)
    // {
    // boolean newflag = ((reg0 & 0x40000) != 0);
    // return newflag;
    ...
    // public static Segment es_hef_STORE1_ES_ldtr_gdtr_reg1(Segment ldtr,
    // Segment gdtr, int reg1)
    // {
    // reg1 &= 0xffff;
    // if (reg1 < 0x4)
    // return SegmentFactory.NULL_SEGMENT;
    ...
    // public static Segment cs_hef_STORE1_CS_ldtr_gdtr_reg1(Segment ldtr,
    // Segment gdtr, int reg1)
    // {
    ...
    // public static Segment ss_hef_STORE1_SS_ldtr_gdtr_reg1(Segment ldtr,
    // Segment gdtr, int reg1)
    // {
    // reg1 &= 0xffff;
    // if (reg1 < 0x4)
    ...
    // public static Segment ds_hef_STORE1_DS_ldtr_gdtr_reg1(Segment ldtr,
    // Segment gdtr, int reg1)
    // {
    // reg1 &= 0xffff;
    // if (reg1 < 0x4)
    ...
    // public static Segment fs_hef_STORE1_FS_ldtr_gdtr_reg1(Segment ldtr,
    // Segment gdtr, int reg1)
    // {
    // reg1 &= 0xffff;
    // if (reg1 < 0x4)
    ...
    // public static Segment gs_hef_STORE1_GS_ldtr_gdtr_reg1(Segment ldtr,
    // Segment gdtr, int reg1)
    // {
    // reg1 &= 0xffff;
    // if (reg1 < 0x4)
    ...
    public static void memorywrite_hef_STORE1_MEM_BYTE_seg0_addr0_reg1(
            Segment seg0, int addr0, int reg1) {
        seg0.setByte(addr0, (byte) reg1);
    }

    public static void memorywrite_hef_STORE1_MEM_WORD_seg0_addr0_reg1(
            Segment seg0, int addr0, int reg1) {
        seg0.setWord(addr0, (short) reg1);
    }

    public static void memorywrite_hef_STORE1_MEM_DWORD_seg0_addr0_reg1(
            Segment seg0, int addr0, int reg1) {
    ...
    public static int eip_nef_LOOP_CX_cs_eip_reg0_ecx(Segment cs, int eip,
            int reg0, int ecx) throws ProcessorException {
        if ((0xffff & (ecx - 1)) != 0)
    ...
    public static int eip_nef_JO_O8_cs_eip_reg0_oflag(Segment cs, int eip,
            int reg0, boolean oflag) throws ProcessorException {
        if (oflag)
            return eip_nef_JUMP_O8_cs_eip_reg0(cs, eip, reg0);
        return eip;
    }
    ...
    public static int eip_nef_JC_O8_cs_eip_reg0_cflag(Segment cs, int eip,
            int reg0, boolean cflag) throws ProcessorException {
        if (cflag)
            return eip_nef_JUMP_O8_cs_eip_reg0(cs, eip, reg0);
        return eip;
    }
    ...
    public static int eip_nef_JZ_O8_cs_eip_reg0_zflag(Segment cs, int eip,
            int reg0, boolean zflag) throws ProcessorException {
        if (zflag)
            return eip_nef_JUMP_O8_cs_eip_reg0(cs, eip, reg0);
        return eip;
    }
    ...
    public static int eip_nef_JNA_O8_cs_eip_reg0_cflag_zflag(Segment cs,
            int eip, int reg0, boolean cflag, boolean zflag)
            throws ProcessorException {
        if (cflag || zflag)
            return eip_nef_JUMP_O8_cs_eip_reg0(cs, eip, reg0);
        return eip;
    ...
    public static int eip_nef_JS_O8_cs_eip_reg0_sflag(Segment cs, int eip,
            int reg0, boolean sflag) throws ProcessorException {
        if (sflag)
            return eip_nef_JUMP_O8_cs_eip_reg0(cs, eip, reg0);
        return eip;
    }
    ...
    public static int eip_nef_JP_O8_cs_eip_reg0_pflag(Segment cs, int eip,
            int reg0, boolean pflag) throws ProcessorException {
        if (pflag)
            return eip_nef_JUMP_O8_cs_eip_reg0(cs, eip, reg0);
        return eip;
    }
    ...
    public static int eip_nef_JL_O8_cs_eip_reg0_oflag_sflag(Segment cs,
            int eip, int reg0, boolean oflag, boolean sflag)
            throws ProcessorException {
        if (sflag != oflag)
            return eip_nef_JUMP_O8_cs_eip_reg0(cs, eip, reg0);
        return eip;
    ...
    public static int eip_nef_JNG_O8_cs_eip_reg0_zflag_sflag_oflag(Segment cs,
            int eip, int reg0, boolean zflag, boolean sflag, boolean oflag)
            throws ProcessorException {
    ...
    public static boolean oflag_nef_SHL_O32_FLAGS_oflag_reg2_reg1(
            boolean oflag, int reg2, int reg1) {
        if (reg1 == 1)
            return ((reg2 & 0xc0000000) != 0)
                    && ((reg2 & 0xc0000000) != 0xc0000000);
        return oflag;
    }
    ...
    public static boolean oflag_nef_ROL_O32_FLAGS_oflag_reg0_reg1(
            boolean oflag, int reg0, int reg1) {
        if (reg1 == 1)
            return ((reg0 & 0x80000001) != 0)
                    && ((reg0 & 0x80000001) != 0x80000001);
        return oflag;
    }
    ...
    public static boolean oflag_nef_ROR_O32_FLAGS_oflag_reg0_reg1(
            boolean oflag, int reg0, int reg1) {
        if (reg1 == 1)
            return ((reg0 & 0xc0000000) != 0)
                    && ((reg0 & 0xc0000000) != 0xc0000000);
        return oflag;
    }
    ...
    public static int eax_nef_IDIV_O8_reg0_eax(int reg0, int eax)
        ...
        return (eax & ~0xffff) | (0xff & result) | ((0xff & remainder) << 8); // AH
                                                                              // is
                                                                              // remainder
    }
    ...
    public static int reg0_hef_IN_O8_cpl_iopl_tss_reg0_ioports(int cpl,
            int iopl, Segment tss, int reg0, IOPortHandler ioports)
    ...
    public static void ioportwrite_hef_OUT_O8_cpl_iopl_tss_reg0_reg1_ioports(
            int cpl, int iopl, Segment tss, int reg0, int reg1,
            IOPortHandler ioports) throws ModuleException {
        if (checkIOPermissionsByte(cpl, iopl, tss, reg0))
    ...
    public static void ioportwrite_hef_OUT_O16_cpl_iopl_tss_reg0_reg1_ioports(
            int cpl, int iopl, Segment tss, int reg0, int reg1,
            IOPortHandler ioports) throws ModuleException {
        if (checkIOPermissionsShort(cpl, iopl, tss, reg0))
    ...
    public static void ioportwrite_hef_OUT_O32_cpl_iopl_tss_reg0_reg1_ioports(
            int cpl, int iopl, Segment tss, int reg0, int reg1,
            IOPortHandler ioports) throws ModuleException {
        if (checkIOPermissionsInt(cpl, iopl, tss, reg0))
    ...
    public static void memorywrite_hef_PUSH_O16_A32_ss_reg0_esp(Segment ss,
        ...
        if (ss.getDefaultSizeFlag()) {
            if ((esp < 2) && (esp > 0))
                throw new ProcessorException(Processor.PROC_EXCEPTION_SS, 0,
                        true);
    ...
    // public static void memorywrite_hef_PUSHF_O16_A32_ss_reg0_esp(Segment ss,
    // int reg0, int esp)
    // {
    // if (ss.getDefaultSizeFlag()) {
    // if ((esp < 2) && (esp > 0))
    ...
    // public static int reg0_hef_POPF_O16_A32_ss_esp_cpl_iopl_iflag(Segment ss,
    // int esp, int cpl, int iopl, boolean iflag)
    // {
    // int flags = 0;
    // if (ss.getDefaultSizeFlag())
    ...
    public static int reg0_hef_POPF_O32_A32_ss_esp_cpl_iopl_vmflag_iflag(
        ...
        if (cpl == 0)
            ...
            if (cpl > iopl)
                flags = (vmflag ? 0x20000 : 0) | (iopl << 12)
                        | (iflag ? 0x200 : 0) | (flags & ~(0x23200 | 0x180000));
            else
                flags = (vmflag ? 0x20000 : 0) | (iopl << 12)
                        | (flags & ~(0x23000 | 0x180000));
        }
    ...
    // public static void
    // memorywrite_hef_PUSHA_A16_edi_esi_ebp_ebx_edx_ecx_eax_ss_esp(int edi, int
    // esi, int ebp, int ebx, int edx, int ecx, int eax, Segment ss, int esp)
    // {
    ...
    // public static int eax_hef_POPA_A16_eax_ss_esp(int eax, Segment ss, int
    // esp)
    // {
    // return (eax & ~0xffff) | (0xffff & ss.getWord(0xffff & (esp + 14)));
    // }

    // public static int ebp_hef_POPA_A16_ebp_ss_esp(int ebp, Segment ss, int
    // esp)
    // {
    // return (ebp & ~0xffff) | (0xffff & ss.getWord(0xffff & (esp + 4)));
    // }

    // public static int ebx_hef_POPA_A16_ebx_ss_esp(int ebx, Segment ss, int
    // esp)
    // {
    // return (ebx & ~0xffff) | (0xffff & ss.getWord(0xffff & (esp + 8)));
    // }

    // public static int ecx_hef_POPA_A16_ecx_ss_esp(int ecx, Segment ss, int
    // esp)
    // {
    // return (ecx & ~0xffff) | (0xffff & ss.getWord(0xffff & (esp + 12)));
    // }

    // public static int edi_hef_POPA_A16_edi_ss_esp(int edi, Segment ss, int
    // esp)
    // {
    // return (edi & ~0xffff) | (0xffff & ss.getWord(0xffff & esp));
    // }

    // public static int edx_hef_POPA_A16_edx_ss_esp(int edx, Segment ss, int
    // esp)
    // {
    // return (edx & ~0xffff) | (0xffff & ss.getWord(0xffff & (esp + 10)));
    // }

    // public static int esi_hef_POPA_A16_esi_ss_esp(int esi, Segment ss, int
    // esp)
    // {
    ...
    public static void memorywrite_hef_PUSHAD_A32_edi_esi_ebp_ebx_edx_ecx_eax_ss_esp(
            int edi, int esi, int ebp, int ebx, int edx, int ecx, int eax,
            Segment ss, int esp) {
        if (ss.getDefaultSizeFlag()) {
            if ((esp < 32) && (esp > 0))
                throw new ProcessorException(Processor.PROC_EXCEPTION_SS, 0,
    ...
    // public static int
    // ecx_hef_REPE_CMPSB_A16_dflag_ecx_es_edi_seg0_esi(boolean dflag, int ecx,
    // Segment es, int edi, Segment seg0, int esi)
    // {
    ...
    // public static int
    // edi_hef_REPE_CMPSB_A16_dflag_edi_es_seg0_esi_ecx(boolean dflag, int edi,
    // Segment es, Segment seg0, int esi, int ecx)
    // {
    // int count = ecx & 0xffff;
    // int addrOne = esi & 0xffff;
    // int addrTwo = edi & 0xffff;
    ...
    // public static int
    // esi_hef_REPE_CMPSB_A16_dflag_esi_es_edi_seg0_ecx(boolean dflag, int esi,
    // Segment es, int edi, Segment seg0, int ecx)
    // {
    // int count = ecx & 0xffff;
    // int addrOne = esi & 0xffff;
    // int addrTwo = edi & 0xffff;
    ...
    // public static int
    // reg1_hef_REPE_CMPSB_A16_dflag_ecx_es_edi_seg0_esi(boolean dflag, int ecx,
    // Segment es, int edi, Segment seg0, int esi)
    // {
    // int count = ecx & 0xffff;
    // int addrOne = esi & 0xffff;
    ...
    // public static int
    // reg2_hef_REPE_CMPSB_A16_dflag_ecx_es_edi_seg0_esi(boolean dflag, int ecx,
    // Segment es, int edi, Segment seg0, int esi)
    // {
    // int count = ecx & 0xffff;
    // int addrOne = esi & 0xffff;
    ...
    // public static int
    // executecount_hef_REPE_CMPSB_A16_dflag_ecx_es_edi_seg0_esi(boolean dflag,
    // int ecx, Segment es, int edi, Segment seg0, int esi)
    // {
    // int count = ecx & 0xffff;
    // int addrOne = esi & 0xffff;
    // int addrTwo = edi & 0xffff;
    ...
    // public static int edi_nef_REP_MOVSB_A16_edi_dflag_ecx(int edi, boolean
    // dflag, int ecx)
    // {
    // int inAddr = 0;
    ...
    // public static int esi_nef_REP_MOVSB_A16_esi_dflag_ecx(int esi, boolean
    // dflag, int ecx)
    // {
    // int outAddr = 0;
    // if (dflag)
    ...
    // public static void
    // memorywrite_hef_REP_MOVSB_A16_dflag_es_edi_seg0_esi_ecx(boolean dflag,
    // Segment es, int edi, Segment seg0, int esi, int ecx)
    // {
    // int count = ecx & 0xffff;
    // int inAddr = edi & 0xffff;
    // int outAddr = esi & 0xffff;
    ...
    // public static int edi_nef_REP_MOVSD_A16_edi_dflag_ecx(int edi, boolean
    // dflag, int ecx)
    // {
    // int inAddr = 0;
    ...
    // public static int esi_nef_REP_MOVSD_A16_esi_dflag_ecx(int esi, boolean
    // dflag, int ecx)
    // {
    // int outAddr = 0;
    // if (dflag)
    ...
    // public static void
    // memorywrite_hef_REP_MOVSD_A16_dflag_es_edi_seg0_esi_ecx(boolean dflag,
    // Segment es, int edi, Segment seg0, int esi, int ecx)
    // {
    // int count = ecx & 0xffff;
    // int inAddr = edi & 0xffff;
    ...
    // public static int edi_nef_REP_MOVSW_A16_edi_dflag_ecx(int edi, boolean
    // dflag, int ecx)
    // {
    // int inAddr = 0;
    ...
    // public static int esi_nef_REP_MOVSW_A16_esi_dflag_ecx(int esi, boolean
    // dflag, int ecx)
    // {
    // int outAddr = 0;
    // if (dflag)
    ...
    // public static void
    // memorywrite_hef_REP_MOVSW_A16_dflag_es_edi_seg0_esi_ecx(boolean dflag,
    // Segment es, int edi, Segment seg0, int esi, int ecx)
    // {
    // int count = ecx & 0xffff;
    // int inAddr = edi & 0xffff;
    ...
    // public static int edi_nef_REP_STOSW_A16_edi_dflag_ecx(int edi, boolean
    // dflag, int ecx)
    // {
    // int inAddr = 0;
    ...
    // public static void
    // memorywrite_hef_REP_STOSW_A16_dflag_reg0_es_edi_ecx(boolean dflag, int
    // reg0, Segment es, int edi, int ecx)
    // {
    // int count = ecx & 0xffff;
    // int addr = edi & 0xffff;
    ...
    // aflag_nef_REP_SUB_O8_FLAGS_aflag_reg1_reg2_reg0(boolean aflag, int reg1,
    // int reg2, int reg0)
    // {
    // if (reg0 == 0)
    // return aflag;
    ...
    // public static boolean
    // cflag_nef_REP_SUB_O8_FLAGS_cflag_reg1_reg2_reg0(boolean cflag, int reg1,
    // int reg2, int reg0)
    // {
    // if (reg0 == 0)
    // return cflag;
    ...
    // public static boolean
    // oflag_nef_REP_SUB_O8_FLAGS_oflag_reg1_reg2_reg0(boolean oflag, int reg1,
    // int reg2, int reg0)
    // {
    // if (reg0 == 0)
    // return oflag;
    ...
    // public static boolean
    // pflag_nef_REP_SUB_O8_FLAGS_pflag_reg1_reg2_reg0(boolean pflag, int reg1,
    // int reg2, int reg0)
    // {
    // if (reg0 == 0)
    // return pflag;
    ...
    // public static boolean
    // sflag_nef_REP_SUB_O8_FLAGS_sflag_reg1_reg2_reg0(boolean sflag, int reg1,
    // int reg2, int reg0)
    // {
    // if (reg0 == 0)
    // return sflag;
    ...
    // public static boolean
    // zflag_nef_REP_SUB_O8_FLAGS_zflag_reg1_reg2_reg0(boolean zflag, int reg1,
    // int reg2, int reg0)
    // {
    // if (reg0 == 0)
    // return zflag;
    ...
    public static int eip_nef_CALL_O32_A32_cs_eip_reg0(Segment cs, int eip,
            int reg0) throws ProcessorException {
        eip += reg0;
        cs.checkAddress(eip);
        return eip;
    }
    ...
    public static int esp_nef_LEAVE_O32_A32_ss_ebp_esp(Segment ss, int ebp,
            int esp) throws ProcessorException {
        if (ss.getDefaultSizeFlag()) {
            ss.checkAddress(ebp);
            return ebp + 4;
        } else {
    ...
    private static final boolean checkIOPermissionsByte(int cpl, int iopl,
            Segment tss, int ioportAddress) {
        if (cpl <= iopl)
            return true;

        int ioPermMapBaseAddress = 0xffff & tss.getWord(102);
        try {
            byte ioPermMapByte = tss.getByte(ioPermMapBaseAddress
                    + (ioportAddress >>> 3));
    ...
    private static final boolean checkIOPermissionsShort(int cpl, int iopl,
            Segment tss, int ioportAddress) {
        if (cpl <= iopl)
            return true;
        ...
        int ioPermMapBaseAddress = 0xffff & tss.getWord(102);
        try {
            short ioPermMapShort = tss.getWord(ioPermMapBaseAddress
                    + (ioportAddress >>> 3));
    ...
    private static final boolean checkIOPermissionsInt(int cpl, int iopl,
            Segment tss, int ioportAddress) {
        if (cpl <= iopl)
            return true;
