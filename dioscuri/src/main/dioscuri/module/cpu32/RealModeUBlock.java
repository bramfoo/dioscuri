...
public class RealModeUBlock implements RealModeCodeBlock, MicrocodeSet {
    ...
    public int execute(Processor cpu) {
        ...
        try {
            ...
            if (e.getVector() != Processor.PROC_EXCEPTION_PF) {
                System.out.println();
                System.out.println("Location: 0x"
                        + Integer.toHexString(cpu.getInstructionPointer()));
                e.printStackTrace();
            }
    ...
    private final void call_far_o32_a16(int targetEIP, int targetSelector) {
        ...
        cpu.ss.setDoubleWord((cpu.esp - 4) & 0xffff, 0xffff & cpu.cs
                .getSelector());
    ...
    private final void int_o16_a16(int vector) {
        ...
        if (vector == 0)
            throw new IllegalStateException("INT 0 allowed? 0x"
                    + Integer.toHexString(cpu.getInstructionPointer()));
