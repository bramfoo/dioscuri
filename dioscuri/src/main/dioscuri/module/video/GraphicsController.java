...
/**
 * Graphics registers Controls how the CPU accesses video RAM<BR>
...
public class GraphicsController {
    ...
    // register.
    // 10b - Result is input from previous stage logical ORed with latch
    // register.
    // 11b - Result is input from previous stage logical XORed with latch
    // register.
    ...
    // 1: map selection enabled; odd map selected when A0 is 1, even map
    // selected when A0 is 0
    ...
    // Used in Write Modes 0, 2 and 3 to select data from ALU (1) or latch
    // register (0)
