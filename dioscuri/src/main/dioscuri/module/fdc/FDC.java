...
public class FDC extends ModuleFDC implements DMATransferCapable {
    ...
    public FDC(Emulator owner) {
        ...
        dor = 0;
        msr = FDC_CMD_DIO; // Set to data direction to read - undocumented
    ...
    public boolean reset() {
        ...
        ModuleDMA dma = (ModuleDMA)super.getModule(Type.DMA);
    ...
    public byte getIOPortByte(int portAddress) throws ModuleException,
        ...
        ModuleATA ata = (ModuleATA)super.getModule(Type.ATA);
