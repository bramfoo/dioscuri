...
public class DeviceDummy extends Module {
    // Attributes
    ...
    public DeviceDummy(Emulator owner) {
        super(Type.DUMMY, Type.MOTHERBOARD);
        emu = owner;
    }
    ...
    public boolean reset() {
        ...
        for (int port = 0x0000; port < motherboard.getIOSpaceSize(); port++) {
