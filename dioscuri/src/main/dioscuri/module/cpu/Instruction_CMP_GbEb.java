...
/**
 * Intel opcode 3A<BR>
 * Byte-sized comparison (SUB) of register ("destination") with memory/register
 * (source).<BR>
 * The addressbyte determines the source (sss bits) and "destination" (rrr
 * bits).<BR>
...
public class Instruction_CMP_GbEb implements Instruction {
    ...
    public void execute()
    {
        ...
        // Determine "destination" value using addressbyte. AND it with 0011
