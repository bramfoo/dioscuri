...
package dioscuri.module.cpu;
	...
	/**
	 * Intel opcode 84<BR>
	 * Logical byte-sized comparison (AND) of memory/register ("destination") and register (source).<BR>
...
public class Instruction_TEST_EbGb implements Instruction {
	...
	public void execute()
	{
        ...
        sourceValue1 = (cpu.decodeRegister(operandWordSize, (addressByte & 0x38) >> 3))[registerHighLow];
