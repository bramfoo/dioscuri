...
/**
 * Intel opcode 8E<BR>
 * Word-sized copy of segment register (destination) from memory/register
 * (source).<BR>
...
public class Instruction_MOV_SwEw implements Instruction {
    ...
    public void execute()
    {
        ...
        if (((addressByte >> 6) & 0x03) == 3) {
            ...
            sourceRegister = cpu.getWordFromMemorySegment(addressByte,
        ...
        destinationRegister = (cpu
                .decodeSegmentRegister((addressByte & 0x38) >> 3));
