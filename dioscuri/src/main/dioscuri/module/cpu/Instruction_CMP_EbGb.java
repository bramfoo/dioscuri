...
package dioscuri.module.cpu;
	...
	/**
	 * Intel opcode 38<BR>
	 * Byte-sized comparison (SUB) of memory/register ("destination") with register (source).<BR>
...
public class Instruction_CMP_EbGb implements Instruction {
	...
	public void execute()
	{
        ...
        if (((addressByte >> 6) & 0x03) == 3)
		{
			...
			destinationValue = cpu.decodeRegister(operandWordSize, addressByte & 0x07)[registerHighLow];
		}
		else
		{
			...
			destinationValue= cpu.getByteFromMemorySegment(addressByte, memoryReferenceLocation);
		}
