...
/**
 * Intel opcode 79<BR>
 * Conditional short jump not sign.<BR>
 * Displacement is relative to next instruction.<BR>
 * Flags modified: none
 */
public class Instruction_JNS implements Instruction {
     ...
     */
    public Instruction_JNS(CPU processor) {
    ...
    public void execute() {
        ...
        // Jump if signed flag NOT set, otherwise skip instruction
        // IP has already been properly updated when bytes were retrieved
        if (!cpu.flags[CPU.REGISTER_FLAGS_SF]) {
