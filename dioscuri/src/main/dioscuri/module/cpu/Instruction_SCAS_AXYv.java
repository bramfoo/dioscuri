...
public class Instruction_SCAS_AXYv implements Instruction {
	...
	public void execute()
	{
        ...
        // Set FLAGS
        // Test AF
        cpu.flags[CPU.REGISTER_FLAGS_AF] = Util.test_AF_SUB(cpu.ax[CPU.REGISTER_GENERAL_LOW], result[CPU.REGISTER_GENERAL_LOW]);
        // Test CF
        cpu.flags[CPU.REGISTER_FLAGS_CF] = Util.test_CF_SUB(cpu.ax, source, 0);
        // Test OF
        cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(cpu.ax, source, result, 0);
