 ...
 * Flags modified: none
 */
public class Instruction_JNL_JGE implements Instruction
{
     ...
     */
    public Instruction_JNL_JGE(CPU processor)
    {
    ...
    public void execute()
    {
        ...
        // Jump if sign flag is equal to overflow flag, otherwise skip instruction
