...
/**
 * Intel opcode 0A<BR>
 * Logical byte-sized OR of register (destination) and memory/register (source).<BR>
 * The addressbyte determines the source (sss bits) and destination (rrr bits).<BR>
 * Flags modified: OF, SF, ZF, AF, PF, CF
 */
public class Instruction_OR_GbEb implements Instruction {
    ...
    public void execute()
    {
        ...
        // Logical OR of source and destination, store result in destination
        // register
