...
package dioscuri.module.cpu;
	...
	/**
	 * Intel opcode 87<BR>
	 * Word-sized content exchange of memory/register (destination) and register (source).<BR>
...
public class Instruction_XCHG_EvGv implements Instruction {
	...
	public void execute()
	{
		...
		if ( ((addressByte & 0xC0) >> 6) == 3)
		{
			...
			System.arraycopy(destinationRegister, 0, tempValue, 0, destinationRegister.length);
		...
		else
		{
			...
			// XCHG source and destination
			tempValue = cpu.getWordFromMemorySegment(addressByte, memoryReferenceLocation);
