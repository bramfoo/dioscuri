...
package dioscuri.module.cpu;
	...
	/**
	 * Intel opcode 1F<BR>
	 * Pop word from stack SP:SS into general register SS.<BR>
	 * Flags modified: none
	 */
public class Instruction_POP_SS implements Instruction {
	...
	public void execute()
	{
        ...
        if (cpu.doubleWord)
        {
            System.out.println("POP_SS: 32-bits not supported");
        }
	}
}
