 ...
 */
public class Instruction_ShiftGRP2_EbCL implements Instruction
{
    ...
    public void execute() throws CPUInstructionException
    {
        ...
        switch ((addressByte & 0x38) >> 3)
        {
            ...
            case 1: // ROR - Rotate bits CL positions right; Flags affected: CF, OF
                ...
                for (int s = 0; s < bitShift; s++)
                {
                    // Rotate right by 1. This is equivalent to a SHR of 1 ORed with a SHL of 7
                ...
                // OF (only defined for 1-bit rotates) is the XOR of the two most-significant bits of the result.
                if (bitShift == 1)
                {
            ...
            case 7: // SAR - Shift CL positions right signed. Flags affected: CF, OF, SF, ZF, PF
                // If bitShift is 0, do nothing, not even flags.
                if (bitShift > 0)
                {
                    // Execute shift on reg or mem. Determine this from mm bits of addressbyte
                    ...
                    // SHR by 1 - on signed value! (This is natural to the Java behaviour)
                    sourceValue[registerHighLow] = (byte) (sourceValue[registerHighLow] >> bitShift);
