...
package dioscuri.module.cpu;
	 ...
	 * After move, contents of SI and DI are incremented or decremented based on DF flag:<BR>
...
public class Instruction_MOVS_XbYb implements Instruction {
	...
	public void execute()
	{
        // Move byte at DS:SI to ES:DI; DS segment override is allowed, ES segment isn't.
