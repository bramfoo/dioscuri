...
//    return ioPortDevice[address].ioPortReadWord(address);
        ...
        int result = ((((int) bytes[0]) & 0xFF) << 8) + (((int) bytes[1]) & 0xFF);
//        int result = ((((int) bytes[1]) & 0xFF) << 8) + (((int) bytes[0]) & 0xFF);
        return result;
    }
...
//        int result = ((((int) bytes[0]) & 0xFF) << 24) + ((((int) bytes[1]) & 0xFF) << 16) + ((((int) bytes[2]) & 0xFF) << 8) + (((int) bytes[3]) & 0xFF);
        int result = ((((int) bytes[3]) & 0xFF) << 24) + ((((int) bytes[2]) & 0xFF) << 16) + ((((int) bytes[1]) & 0xFF) << 8) + (((int) bytes[0]) & 0xFF);
        return result;
    }
...
//    ioPortDevice[address].ioPortWriteWord(address, data);
        byte[] dataWord = new byte[]{((byte) ((data >> 8 ) & 0xFF)), ((byte) (data & 0xFF))};
...
//    ioPortDevice[address].ioPortWriteLong(address, data);
        byte[] dataDWord = new byte[]{((byte) ((data >> 24) & 0xFF)), ((byte) ((data >> 16 ) & 0xFF)), ((byte) ((data >> 8 ) & 0xFF)), ((byte) (data & 0xFF))};
