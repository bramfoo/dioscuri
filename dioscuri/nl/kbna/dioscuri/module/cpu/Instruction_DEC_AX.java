...
package nl.kbna.dioscuri.module.cpu;
	...
	/**
	 * Intel opcode 48<BR>
	 * Decrement general register AX.<BR>
	 * Flags modified: OF, SF, ZF, AF, PF
	 */
public class Instruction_DEC_AX implements Instruction {
	 ...
	 */
	public Instruction_DEC_AX(CPU processor)
	{
		//this();
	...
	public void execute()
	{
		...
		// Decrement the AX register
		temp = Util.subtractWords(cpu.ax, decWord, 0);
        ...
        // Test OF
        cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(oldValue, decWord, cpu.ax, 0);  
		// Test ZF
