...
public class Instruction_DEC_CX implements Instruction {
    ...
    {
        // Store old value
        System.arraycopy(cpu.cx, 0, oldValue, 0, cpu.cx.length);
        ...
        // Test AF
        cpu.flags[CPU.REGISTER_FLAGS_AF] = Util.test_AF_SUB(oldValue[CPU.REGISTER_GENERAL_LOW], cpu.cx[CPU.REGISTER_GENERAL_LOW]);  
        // Test OF
        cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(oldValue, decWord, cpu.cx, 0);  
        // Test ZF
