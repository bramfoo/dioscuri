...
public class Instruction_DEC_DX implements Instruction {
    ...
    {
        // Store old value
        System.arraycopy(cpu.dx, 0, oldValue, 0, cpu.dx.length);
        ...
        // Test AF
        cpu.flags[CPU.REGISTER_FLAGS_AF] = Util.test_AF_SUB(oldValue[CPU.REGISTER_GENERAL_LOW], cpu.dx[CPU.REGISTER_GENERAL_LOW]);  
        // Test OF
        cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(oldValue, decWord, cpu.dx, 0);  
        // Test ZF
