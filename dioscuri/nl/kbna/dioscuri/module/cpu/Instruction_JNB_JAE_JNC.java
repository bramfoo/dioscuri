...
/**
 * Intel opcode 73<BR>
 * Conditional short jump not carry.<BR>
 * Displacement is relative to next instruction.<BR>
 * Flags modified: none
 */
public class Instruction_JNB_JAE_JNC implements Instruction
{
     ...
     * Class constructor
     */
    public Instruction_JNB_JAE_JNC()
    {
    }
     ...
     */
    public Instruction_JNB_JAE_JNC(CPU processor)
    {
        // this();
