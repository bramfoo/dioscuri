...
public class Instruction_DEC_BX implements Instruction {
    ...
    {
        // Store old value
        System.arraycopy(cpu.bx, 0, oldValue, 0, cpu.bx.length);
        ...
        // Test AF
        cpu.flags[CPU.REGISTER_FLAGS_AF] = Util.test_AF_SUB(oldValue[CPU.REGISTER_GENERAL_LOW], cpu.bx[CPU.REGISTER_GENERAL_LOW]);  
        // Test OF
        cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(oldValue, decWord, cpu.bx, 0);  
        // Test ZF
