...
public class Instruction_DEC_SI implements Instruction {
    ...
    {
        // Store old value
        System.arraycopy(cpu.si, 0, oldValue, 0, cpu.si.length);
        ...
        // Test AF
        cpu.flags[CPU.REGISTER_FLAGS_AF] = Util.test_AF_SUB(oldValue[CPU.REGISTER_GENERAL_LOW], cpu.si[CPU.REGISTER_GENERAL_LOW]);  
        // Test OF
        cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(oldValue, decWord, cpu.si, 0);  
        // Test ZF
