...
package nl.kbna.dioscuri.module.cpu;
	...
	/**
	 * Intel opcode 39<BR>
	 * Word-sized comparison (SUB) of memory/register ("destination") with register (source).<BR>
...
public class Instruction_CMP_EvGv implements Instruction {
	...
	public void execute()
	{
        ...
        if (((addressByte >> 6) & 0x03) == 3)
		{
			...
			destinationValue = cpu.decodeRegister(operandWordSize, addressByte & 0x07);
		}
		else
		{
			...
			destinationValue = cpu.getWordFromMemorySegment(addressByte, memoryReferenceLocation);
		}
