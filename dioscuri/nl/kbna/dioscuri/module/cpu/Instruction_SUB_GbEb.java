 ...
 */
public class Instruction_SUB_GbEb implements Instruction
{
    ...
    public void execute()
    {
        ...
        // SUB source and destination, storing result in destination. registerHighLow is re-used here.
        ...
        // Test OF
        cpu.flags[CPU.REGISTER_FLAGS_OF] = Util.test_OF_SUB(oldValue, sourceValue, destinationRegister[registerHighLow], 0);
