...
//    handleHardProtectedModeInterrupt(interruptController.cpuGetInterrupt());
    handleHardProtectedModeInterrupt(interruptController.interruptAcknowledge());
    }
    }
eflagsInterruptEnable = eflagsInterruptEnableSoon;
}
...
{
boolean result = (physicalMemory.updated() && linearMemory.updated() && ioports.updated() && interruptController.isConnected());// && virtualClock.updated() && interruptController.updated());
return result;
}
...
/*
 * (non-Javadoc)
 * @see nl.kbna.dioscuri.module.ModuleCPU#getIPS()
 * Added constant to keep Dioscuri clock happy
 */
public int getIPS()
{
...
/*
 * (non-Javadoc)
 * @see nl.kbna.dioscuri.module.ModuleCPU#interruptRequest(boolean)
 * Added method body to propagate JPC generated commands.
 */
