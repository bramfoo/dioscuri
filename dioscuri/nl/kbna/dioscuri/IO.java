...
import nl.kbna.dioscuri.exception.CommandException;
...
public class IO
{
    ...
    // Logging
    private static Logger logger = Logger.getLogger("nl.kbna.dioscuri.io");
     ...
     * 
     * @param String filename specifying the name of the inputstream from the filesystem
    ...
    {
        // open input stream
        BufferedInputStream bdis = new BufferedInputStream(new DataInputStream(new FileInputStream(new File(filename))));
     ...
     * 
     * @param String filename specifying the name of the file
     * @param String data
     * @return boolean, true is successful, false otherwise
     * @throws IOException
     */
    public void exportBinaryStream(String filename, String data) throws IOException
    {
        // open output stream
     ...
     * 
     * @param cmd input string array containing commands and arguments
     */
    public int getCommand()
    {
        ...
        try
        {
            ...
            // s [<NUMBER>] = step through the execution process by 1 or number steps
            // r = display contents of registers
            // m <start> [bytes] = display memory contents
            // d <MODULE> = show dump of all modules, or module specified by its type
            ...
            {
                // Step: s [<NUMBER>]
                // Performs n steps in execution process, with n = 1 or n = <NUMBER>
            ...
            {
                // Dump: d <MODULE>
                // Displays a dump of all modules, or only from one given moduletype
            ...
            {
                // m <address> [bytes]
                // Displays the contents of the memory at <address>, [bytes] long 
